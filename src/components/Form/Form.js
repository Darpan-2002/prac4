...
const Form = () => {
  ...
  return (
    ...
    {account?( <form onSubmit={submitHandler}>
        <h1>Road & Insfrastructure Fund Details</h1>
        ...
        >
          ...
          <option value="For road">For road</option>
          <option value="For bridge">For bridge</option>
          <option value="For playground">For playground</option>
